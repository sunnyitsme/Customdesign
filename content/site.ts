...
export const FIRM_CONFIRMATION_REQUIRED = '[FIRM CONFIRMATION REQUIRED]' as const;
...
export const sourceConflicts = [
  {
    id: 'primary-address',
    summary: 'Public site uses Brentford/London; the Terms of Business and Privacy Notice PDFs use Manchester/Sale.',
  },
  {
    id: 'primary-email',
    summary: 'Public site uses enquiries@guidefs.co.uk; the legal PDFs use info@guidemortgages.co.uk.',
  },
  {
    id: 'office-count',
    summary: 'The Company page names three offices; the global footer lists four (Leeds is the difference).',
  },
] as const;
...
export const site = {
  ...
  offices: [
    { city: 'London', address: '1st Floor, 1000 Great West Road, Brentford, London TW8 9DW' },
    { city: 'Manchester', address: 'Ground Floor, Dunham House, Cross Street, Sale, M33 7HH' },
    { city: 'Leicester', address: 'Unit D5, Leicester Business Centre, Ross Walk, Leicester, LE4 5HH' },
    { city: 'Leeds', address: 'Office 3, Millwright Business Centre, Regent Street, Leeds, LS2 7NA' },
