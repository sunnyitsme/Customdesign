...
export function PendingContent({
  ...
  if (process.env.NODE_ENV === 'production') return <div className={className}>{children}</div>;
  ...
  return (
    <div className={className}>
      ...
      <div className="outline-1 outline-dashed outline-offset-4 outline-accent/35">{children}</div>
    </div>
  );
}
