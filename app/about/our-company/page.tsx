  ...
  return (
    <>
      <PageOpening
        ...
        title="Our company"
        standfirst="A corporate overview of the firm, its services and how it is structured."
        crumbs={[
          { label: "Home", href: "/" },
          { label: "About", href: "/about" },
          { label: "Our company" },
        ]}
        image={requireHeroImage("/about/our-company")}
      />
      <section
        ...
        <Container>
          <DatumGrid>
            ...
            <div>
              ...
              <PendingContent
                label="about.copy — approved wording required"
                className="mt-9"
              >
